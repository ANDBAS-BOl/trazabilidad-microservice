...
class ArchitectureRulesTest {
    ...
    private static final String BASE_PACKAGE = "com.pragma.powerup.trazabilidad";
    ...
    @Test
    void domainShouldNotDependOnMongoDb() {
        noClasses()
                .that().resideInAPackage("..domain..")
                .should().dependOnClassesThat().resideInAPackage("org.springframework.data.mongodb..")
                .because("Domain must not depend on Spring Data Mongo types")
                .check(importedClasses);
    }
    ...
    @Test
    void applicationShouldNotDependOnInfrastructureExceptMapper() {
        noClasses()
    ...
    @Test
    void controllersShouldNotDependOnMongoDocuments() {
        noClasses()
                .that().resideInAPackage("..infrastructure.input.rest..")
                .should().dependOnClassesThat().resideInAPackage("..infrastructure.out.mongo.document..")
                .because("Controllers must not reference Mongo documents")
                .check(importedClasses);
    }
    ...
    void noLegacyRepositoryPackageAtRoot() {
        assertTrue(
                ...
                "Repositories must live under infrastructure, not at package root");
    }
