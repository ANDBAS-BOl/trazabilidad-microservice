...
import com.pragma.powerup.trazabilidad.infrastructure.security.JwtTokenProvider;
...
class OrderTraceApiIT {
    ...
    void clienteNoPuedeConsultarPedidoDeOtro_forbidden() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/trazabilidad/pedidos/8001")
                ...
                .andExpect(jsonPath("$.message").value(DomainErrorMessage.UNAUTHORIZED_TRACE_ACCESS.getMessage()));
    }
